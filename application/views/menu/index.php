...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div>
                <a href="" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mb-4" data-toggle="modal" data-target="#newMenuModal"><i class="fas fa-fw fa-plus"></i> Add New Menu</a>
            </div>
            <!-- end Page Heading -->
